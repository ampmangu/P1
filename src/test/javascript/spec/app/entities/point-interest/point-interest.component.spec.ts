...
import { PointInterestComponent } from 'app/entities/point-interest/point-interest.component';
...
describe('Component Tests', () => {
    describe('PointInterest Management Component', () => {
        let comp: PointInterestComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [PointInterestComponent],
                providers: [
                    {
                ...
                .overrideTemplate(PointInterestComponent, '')
                .compileComponents();
